    ...
    return SmartAnalysis(
        ...
        sector_implications=[
            SectorImplication(
                ...
                affected_subsectors=["REITs", "Homebuilders", "Commercial Real Estate"],
            ),
            SectorImplication(
                sector="Financials",
                direction=Direction.bullish,
                ...
                affected_subsectors=["Regional Banks", "Insurance", "Asset Managers"],
            ),
            SectorImplication(
                sector="Technology",
                direction=Direction.bullish,
                ...
                affected_subsectors=["Software", "Cloud Computing", "AI Infrastructure"],
            ),
        ],
